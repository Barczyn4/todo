			...
			this.httpClient.configure(function (config) {
				config.withBaseUrl(_this.BASE_URL).withDefaults({
					...
					request: function request(_request) {
						var autHeader = console.log('Requesting ${request.method}, ${request.url}');
						return _request;
					},
...
define('text!resources/elements/flatpickr.html', ['module'], function(module) { module.exports = "<template><require from=\"flatpickr/flatpickr.css\"></require><div class=\"input-group aurelia-flatpickr\"><input type=\"text\" class=\"aurelia-flatpickr form-control flatpickr\" data-input></div></template>"; });
